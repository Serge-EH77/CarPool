...
export default function DriverSettings() {
  ...
  async function updateProfile() {
    ...
    const res = await fetch("/api/driver/settings/update", {
      method: "POST",
  ...
  async function changePassword() {
    ...
    const res = await fetch("/api/driver/settings/password", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
    ...
    <div className="p-6 max-w-4xl mx-auto space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage your profile, vehicle details, and account security.
          </p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Your car details used for assignments.</CardDescription>
        </CardHeader>
